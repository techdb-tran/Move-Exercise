<template>
    <div class="relative verified">
      ...
      <div class="rounded-lg py-2 px-2 verified--defined font-normal text-sm">
        A verified badge for confirms that this is an
        authentic Page for this public figure, media company or brand
      </div>
    </div>
