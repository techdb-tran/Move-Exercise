<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="110.315" height="24" viewBox="0 0 110.315 24">
    <g id="Group_2137" data-name="Group 2137" transform="translate(-225.385 -177.2)">
